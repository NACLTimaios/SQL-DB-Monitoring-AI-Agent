...
# Palo Alto Prisma AIRS API endpoint
# Note: service.api endpoint works for all regions despite being generic-looking
# API keys are region-locked but all regions use the same endpoint URL
